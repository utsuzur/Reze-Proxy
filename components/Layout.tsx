    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-reze-200">
      {isAdmin && (
        <>
          ...
          {/* Sidebar */}
          <nav className={`fixed left-0 top-0 h-full w-64 bg-white border-r border-reze-100 flex flex-col shadow-xl z-50 transition-transform duration-300 md:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            ...
            <div className="p-4 border-t border-reze-50">
              <Link to="/" className="flex items-center gap-2 text-sm text-slate-500 hover:text-reze-600 transition-colors">
